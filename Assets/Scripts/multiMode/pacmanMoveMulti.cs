...
public class pacmanMoveMulti : NetworkBehaviour {
    ...
    public void Start()
    {
        ...
        this.currentMove.Add("top", false);
        this.currentMove.Add("bottom", false);
        this.currentMove.Add("right", false);
        this.currentMove.Add("left", false);
    }
    ...
    public void Update()
    {
        ...
        {
            SceneManager.UnloadSceneAsync("multiMode");
